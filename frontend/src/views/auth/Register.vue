  ...
  <div>
    ...
    <form @submit.prevent="handleRegister" class="space-y-4">
      <div>
        ...
        <input id="username" v-model="form.username" type="text" required class="input-field"
          :class="{ 'border-red-500': usernameError, 'border-green-500': usernameValid }"
          placeholder="사용자명을 입력하세요 (3-50자)" :disabled="isLoading" @blur="checkUsername" />
      ...
      <div>
        ...
        <input id="email" v-model="form.email" type="email" required class="input-field"
          :class="{ 'border-red-500': emailError, 'border-green-500': emailValid }" placeholder="이메일을 입력하세요"
          :disabled="isLoading" @blur="checkEmail" />
      ...
      <div>
        ...
        <input id="password" v-model="form.password" type="password" required class="input-field"
          :class="{ 'border-red-500': passwordError }" placeholder="비밀번호를 입력하세요 (최소 8자)" :disabled="isLoading" />
      ...
      <div>
        ...
        <input id="confirmPassword" v-model="confirmPassword" type="password" required class="input-field"
          :class="{ 'border-red-500': confirmPasswordError }" placeholder="비밀번호를 다시 입력하세요" :disabled="isLoading" />
